...
?>
		<br />
		<div class="container">
			<h3 align="center">Add your Expertise Info</h3>
			<br />
			<div class="card">
				<div class="card-header">Enter your Expertise Info</div>
				<div class="card-body">
					...
					<form method="post" id="insert_form">
						<div class="table-repsonsive">
							...
							<table class="table table-bordered" id="item_table">
								<tr>
									<th>Expertise Information Description</th>
...
$(document).ready(function(){
	...
	function add_input_field(count)
	{
		...
		html += '<td><input type="text" name="expertise_info[]" class="form-control expertise_info" /></td>';
	...
	$('#insert_form').on('submit', function(event){
		...
		$('.expertise_info').each(function(){

			if($(this).val() == '')
			{

				error += "<li>Enter expertise_info at  Row "+count+"</li>";
		...
		if(error == '')
		{
			...
			$.ajax({
				...
				url:"add_expertise_info_logic.php",
