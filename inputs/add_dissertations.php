...
?>
		<br />
		<div class="container">
			<h3 align="center">Add your Dissertations</h3>
			<br />
			<div class="card">
				<div class="card-header">Enter your Dissertations</div>
				<div class="card-body">
					...
					<form method="post" id="insert_form">
						<div class="table-repsonsive">
							...
							<table class="table table-bordered" id="item_table">
								<tr>
									<th>Dissertations Description</th>
                                    <th>Role</th>
                                    <th>Duration</th>
...
$(document).ready(function(){
	...
	function add_input_field(count)
	{
		...
		html += '<td><input type="text" name="dissertation_description[]" class="form-control dissertation_description" /></td>';
	...
	$('#insert_form').on('submit', function(event){
		...
		$('.dissertation_description').each(function(){

			if($(this).val() == '')
			{

				error += "<li>Enter  dissertation_description at  Row "+count+"</li>";
        ...
        $('.role').each(function(){
            ...
            if($(this).val() == '')
            {
                ...
                error += "<li>Enter Role  at  Row "+count+"</li>";
		...
		if(error == '')
		{
			...
			$.ajax({
				...
				url:"add_dissertations_logic.php",
