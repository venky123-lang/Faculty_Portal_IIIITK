...
?>
		<br />
		<div class="container">
			<h3 align="center">Add your projects</h3>
			<br />
			<div class="card">
				<div class="card-header">Enter your projects </div>
				<div class="card-body">
...
$(document).ready(function(){
	...
	function add_input_field(count)
	{
		...
		html += '<td><input type="text" name="project_title[]" class="form-control project_title" /></td>';
	...
	$('#insert_form').on('submit', function(event){
		...
		$('.project_title').each(function(){
			...
			if($(this).val() == '')
			{
				...
				error += "<li>Enter project_title at  Row "+count+"</li>";
